	...
	<div align="center">
		...
		<table border="1" cellspacing="0" width="600">
			...
			<c:if test="${!empty list }">
				<c:forEach items="${list }" var="dto">
					<tr>
						...
						<td>
							<a href="<%=request.getContextPath()%>/bbs_cont.do?no=${dto.getBoard_no() }&page=${page }">${dto.getBoard_title() }</a> 
						</td>
			...
			<tr>
				...
				<td colspan="7" align="right"><input type="button" value="글쓰기"
					onclick="location.href='<%=request.getContextPath() %>/bbs_write.do'">
				</td>
			</tr>
		</table>
		<br>
		...
		<form method="post"
	      action="<%=request.getContextPath() %>/bbs_search.do">
